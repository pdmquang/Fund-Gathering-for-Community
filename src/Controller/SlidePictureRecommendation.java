...
public class SlidePictureRecommendation {
    ...
    public ObservableList<StackPane> addFlipPane(ObservableList<ImageView> imageList,CharityEventRecommendation eventEntity)
{
...
//    		System.out.println(node.getAccessibleText());
    ...
    public ObservableList<GridPane> createBackListNode(CharityEventRecommendation eventEntity)
    {
    	ObservableList<GridPane> gridList = FXCollections.observableArrayList();
    	List<String> pictureFile = db_function.retrieveRecommend().getImage();
