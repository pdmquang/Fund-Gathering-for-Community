...
public class CharityEvent {
	...
	public CharityEvent(String eventTitle, String eventType, String startDate, String endDate)
	{
	...
	public CharityEvent(List<String> category, List<String> name, List<String> start, List<String> end,
